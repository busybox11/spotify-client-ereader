...
const playlistSongItem = `<div class="playlist-song" onclick="playSongWithContext('{context_uri}', '{song_offset}')">
...
const albumSongItem = `<div class="album-song" onclick="playSongWithContext('{context_uri}', '{song_offset}')">
